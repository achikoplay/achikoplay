    ...
    <main>
      ...
      <article>
        <div class="maincontent relative">
          <div class="banner__game backgroundCoverCenter" style="background-image: url(<?php echo url('asset/static/tournamentsecond.jpg');?>)">
            <div class="banner__game--container relative">
              <div class="banner__game--container--image relative">
                <img class="img-fluid invisible" src="<?php echo url('asset/static/tournamentsecond.jpg')?>" alt="placeholder" />
          ...
          <div class="tournament__overview">
            <div class="container">
              <div class="row">
                    ...
                    <div class="row">
                      ...
                      <div class="col-md-3">
                        <div class="tournament__overview--pricemanagedesc__man">
                          ...
                          <div class="row mt-5">
                            <div class="col-12">
                              <a href="#" class="btn btn-big-outline text-white"><h4 class="mb-0">Rules</h4></a>
                            </div>
                          </div>
                          <br/>
                          <div class="row">
                            <div class="col-12">
                              <a href="#" class="btn btn-big-outline text-white"><h4 class="mb-0">How to Join</h4></a>
                            </div>
                          </div>
                        </div>
                      </div>
                ...
                <div class="col-12">
                  <div class="tournament__overview--tab">
                    <ul class="nav nav-tabs nunitoLight" id="myTab" role="tablist">
                      ...
                      <li class="nav-item">
                        <a class="nav-link" target="_blank" id="close-tab" href="<?php echo url('tournamentoverview.php')?>">
                          <h5 class="mb-0">Closed Qualifier</h5>
                        </a>
                      </li>
                      <li class="nav-item">
                        <a class="nav-link active" id="mainevent-tab" data-toggle="tab" href="#mainevent" role="tab" aria-controls="mainevent" aria-selected="true">
                    ...
                    <div class="tab-content" id="myTabContent">
                          ...
                          <div class="row mt-5 mb-5">
                            <div class="col-12">
                              <div class="tournament__overview--tab--participant__linksubmit">
                                <div class="row">
                                  <div class="col-md-4">
                                    <a href="" class="btn btn-big-join nominus btn-warning d-block">MATCH</a>
                                  </div>
                                  <div class="col-md-4">
                                    <a href="" class="btn btn-big-join nominus btn-warning d-block">BRACKET</a>
                                  </div>
                                  <div class="col-md-4">
                                    <a href="" class="btn btn-big-join nominus btn-warning d-block">WATCH</a>
                                  </div>
                                </div>
                              </div>
                            </div>
                      ...
                      <div class="tab-pane fade show active" id="mainevent" role="tabpanel" aria-labelledby="mainevent-tab">
