    ...
    <main>
      ...
      <article>
        <div class="maincontent">
          <div class="banner__game backgroundCoverCenter" style="background-image: url(<?php echo url('asset/static/banner-ml.jpg');?>)">
            <div class="banner__game--container relative">
              <div class="banner__game--container--image relative">
                <img class="img-fluid invisible" src="<?php echo url('asset/static/banner-ml.jpg')?>" alt="dota" />
