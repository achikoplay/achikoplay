      ...
      <article>
        <div class="maincontent">
          <div class="container maincontent__followlist mt-5 mb-5">
              <div class="row">
                <div class="col-md-12">
                  <h3 class="nunitoLight pl-3 mb-3 text-center">You’re Followers</h3>
                  <div class="row mt-5">
                    <div class="col-md-4">
                            ...
                            <div class="col-7">
                              <div class="d-flex align-items-center">
                                ...
                                <div class="followlist__item--text ml-3">
                                  ...
                                  <span class="text-muted small">524.980 Followers</span>
                                </div>
                              </div>
                            </div>
                            <div class="col-5">
                              <div class="d-flex align-items-center justify-content-end h-100">
                                <a href="#" class="btn-small-grey">Unfollow</a>
                              </div>
                            </div>
                          </div>
                        </div>
