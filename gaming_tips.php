    ...
    <main>
      ...
      <article>
        <div class="maincontent">
          <div class="container maincontent__games mt-5">
              <div class="row">
                <div class="col-md-12">
                  <div class="clearfix text-center">
                    <h2 class="font-weight-light"><i class="fas fa-users text-warning"></i> Gaming Tips</h2>
                  </div>
                  <div class="clearfix">&nbsp;<br/>&nbsp;</div>
                  <div class="row">
                    <?php for ($o=1; $o <= 12 ; $o++) {?>
                      <div class="col-lg-4 col-md-4 col-12 maincontent_games--item">
                        <div class="maincontent__widget--games--image mb-5">
                          <a href="gaming_tips_overview.php" class="relative d-block">
                            <img src="<?php echo url('asset/static/gametips/image.jpg');?>" alt="image-gametips" class="img-fluid"/>
                            <div class="maincontent__widget--games--icon backgroundCoverCenter" style="background-image: url('<?php echo url('asset/static/gametips/2.png');?>')">&nbsp;</div>
