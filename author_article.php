    ...
    <main>
      ...
      <article>
        <div class="maincontent">
          <div class="container maincontent__posts mt-5">
              <div class="row">
                <div class="col-md-12">
                  <div class="clearfix text-center">
                    <h2 class="font-weight-light">Articles by Author</h2>
                  </div>
                  <div class="maincontent__posts--author--wrapper">
                    <div class="row">
                      <div class="col-3">
                        <img src="https://i.pravatar.cc/150?img=3" class="rounded-circle" />
                      </div>
                      <div class="col-9">
                        <h4>Victor Djemba Djembo</h4>
