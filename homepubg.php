    ...
    <main>
      ...
      <article>
        <div class="maincontent">
          <div class="banner__game backgroundCoverCenter" style="background-image: url(<?php echo url('asset/static/banner-pubg.jpg');?>)">
            <div class="banner__game--container relative">
              <div class="banner__game--container--image relative">
                <img class="img-fluid invisible" src="<?php echo url('asset/static/banner-pubg.jpg')?>" alt="dota" />
            ...
            <div class="container maincontent__widget--news relative">
              <div class="row">
                ...
                <div class="col-md-4 mb-30px">
                  <div class="w-100 relative backgroundCoverTop maincontent__widget--news--rightbanner" style="background-image: url('<?php echo url('asset/static/pubg-right.jpg')?>')">
                    <a href="#" class="d-block text-white">
                      <img src="<?php echo url('asset/static/pubg-right.jpg')?>" class="img-fluid invisible" alt="img"/>
